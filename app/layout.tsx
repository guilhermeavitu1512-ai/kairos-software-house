...
const description = "Sites a partir de R$ 397, com escopo definido e atendimento direto pelo WhatsApp. Sistemas, aplicativos e automações sob orçamento.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description,
    openGraph: { title, description, type: "website", locale: "pt_BR", siteName: "KAIROS", images: [{ url: `${origin}/og-kairos-editorial.png`, width: 1731, height: 909, alt: "KAIROS — Transformamos problemas em software." }] },
