...
export const projectRecords: ProjectRecord[] = [
  {
    ...
    name: "VYNE",
    category: "E-commerce",
    description: "Uma experiência de compra de relógios desenhada para unir curadoria, clareza e presença de marca.",
    image: "/portfolio/vyne.png",
    url: "/projetos/vyne",
    featured: true,
    portfolio: true,
    order: 1,
