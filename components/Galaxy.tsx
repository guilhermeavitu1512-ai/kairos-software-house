"use client";
// React Bits Galaxy TS-CSS. Integration guard keeps the intro usable without WebGL.
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      // Keep the final starfield frame while the intro fades into the Hero.
      if (ctn.closest('[data-entering]')) return;
